    ...
    fs.createReadStream(INPUT_CSV)
        ...
        .on('end', () => {
            ...
            const distinctionRow = [
                ...
                ...subjects.map((subject) => ({ v: distinctionCounts[subject], t: 'n', s: styles.distinctionTotalStyle }))
            ];
            ...
            const supplyRow = [
                ...
                ...subjects.map((subject) => ({ v: supplyCounts[subject], t: 'n', s: styles.failedTotalStyle }))
            ];
